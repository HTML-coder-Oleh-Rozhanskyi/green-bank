var Swiper = function() {
    ...
    function I(e) {
        return void 0 === e && (e = {}), C || (C = function(e) {
            ...
            const s = L(), a = r(), i = a.navigator.platform, n = t || a.navigator.userAgent, l = {
                ios: !1,
                android: !1
    ...
    const te = {
        ...
        breakpoints: {
            setBreakpoint: function() {
                ...
                const l = (n in r ? r[n] : void 0) || e.originalParams, o = Q(e, a), d = Q(e, l), c = e.params.grabCursor, u = l.grabCursor, m = a.enabled;
            ...
            s({
                ...
                setTranslate: ()=>{
                    ...
                    for(let s = 0; s < e.length; s += 1){
                        ...
                        const r = t.params.fadeEffect.crossFade ? Math.max(1 - Math.abs(e.progress), 0) : 1 + Math.min(Math.max(e.progress, -1), 0), n = ue(0, e);
            ...
            s({
                ...
                setTranslate: ()=>{
                    ...
                    for(let e = 0, s = a.length; e < s; e += 1){
                        const s = a[e], l = i[e], p = (o - s.swiperSlideOffset - l / 2) / l, u = "function" == typeof r.modifier ? r.modifier(p) : p * r.modifier;
                        ...
                        if (ue(0, s).style.transform = y, s.style.zIndex = 1 - Math.abs(Math.round(u)), r.slideShadows) {
                            let e = n ? s.querySelector(".swiper-slide-shadow-left") : s.querySelector(".swiper-slide-shadow-top"), t = n ? s.querySelector(".swiper-slide-shadow-right") : s.querySelector(".swiper-slide-shadow-bottom");
